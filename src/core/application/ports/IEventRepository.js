...
class IEventRepository {
    ...
    async addParticipant(eventId, walletId, pointsEarned) { throw new Error('Not implemented'); }
    ...
    async findParticipationById(participantId) { throw new Error('Not implemented'); }
